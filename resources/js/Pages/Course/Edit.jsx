...
export default function CreateCourse({ auth, course, courses }) {	
	...
	return (
		<AuthenticatedLayout
			user={auth.user}
			header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Course Update</h2>}
		>
