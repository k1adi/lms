...
The app.css file (usually labelled `main.scss`) is reference guideline how to write maintanable scss. It should be the only Sass file from the whole code base not to begin with an underscore. This file should not contain anything but `@import` and comments.
